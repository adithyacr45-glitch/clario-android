...
public class MainActivity extends Activity {
    ...
    private boolean isAllowedInWebView(Uri uri) {
        ...
        return h.equals("debate-social.hatchable.site")
            || h.equals("vzdufmykteikcbyaokpw.supabase.co")
    ...
    private void registerBackHandler() {
        if (Build.VERSION.SDK_INT >= 33) {
            getOnBackInvokedDispatcher()
                .registerOnBackInvokedCallback(0, this::handleBack);
        }
    }
    ...
    private void handleBack() {
        ...
        webView.evaluateJavascript(
            "(function(){try{return !!(window.CLARIO_ANDROID_BACK&&window.CLARIO_ANDROID_BACK());}catch(e){return false;}})();",
            value -> {
